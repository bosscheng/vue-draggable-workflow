...
export const workflowItem3 = {
    ...
    steps: [{
        ...
        "stepId": "c89829f5-8595-458c-b040-4ff84d27befc",
        "nextSteps": [{
            "nextStep": "bda7748f-f87d-4a04-880e-eca936d59a0e",
            "name": "1",
            "isDefault": false
        }, {
            "nextStep": "7bd4fc3d-c3b9-4b19-81dc-e49cd1e7b5c5",
            "name": "2",
            "isDefault": false
        }, {"nextStep": "85c30556-75fa-441c-9a1d-0dced21755a5", "name": "3", "isDefault": false}],
        "stepName": "条件分组"
    }, {
        "elementId": "conditionNode",
        "stepId": "7bd4fc3d-c3b9-4b19-81dc-e49cd1e7b5c5",
        "nextSteps": [{
            ...
            "isDefault": false,
            "ruleGroups": []
        }, {"nextStep": "da100cd2-a2fd-4967-911f-3acb1036d249", "name": "否", "isDefault": true, "ruleGroups": []}],
        "stepName": "条件判断",
        "stepJson": "{}"
    }, {
        "elementId": "conditionNode",
        ...
        "nextSteps": [{
            ...
            "isDefault": false,
            "ruleGroups": []
        }, {"nextStep": "70712f8b-d164-4224-89fd-983a9a20f6b7", "name": "否", "isDefault": true, "ruleGroups": []}],
        "stepName": "条件判断",
        "stepJson": "{}"
    }, {
        "elementId": "nodeNode",
        ...
        "nextSteps": [{
            ...
            "isDefault": false,
            "ruleGroups": []
        }, {"nextStep": "d2a791f1-7bd7-4cde-ab7c-2e8fab3bb869", "name": "否", "isDefault": true, "ruleGroups": []}],
        "stepName": "条件判断",
        "stepJson": "{}"
    }, {
        "elementId": "nodeNode",
        ...
        "nextSteps": [{
            ...
            "isDefault": false,
            "ruleGroups": []
        }, {"nextStep": "89bf2095-030f-4c5f-9d52-1f97cab2e295", "name": "否", "isDefault": true, "ruleGroups": []}],
        "stepName": "条件判断",
        "stepJson": "{}"
    }, {
        "elementId": "stopNode",
        ...
        "nextSteps": [{
            ...
            "isDefault": false,
            "ruleGroups": []
        }, {"nextStep": "88e3aee3-d01c-432e-af05-d79d922c55df", "name": "否", "isDefault": true, "ruleGroups": []}],
        "stepName": "条件判断",
        "stepJson": "{}"
    }, {
        "elementId": "nodeNode",
        ...
        "nextSteps": [{
            ...
            "isDefault": false,
            "ruleGroups": []
        }, {"nextStep": "512f2bac-82ca-4ecc-8e71-a0171e8beb4a", "name": "否", "isDefault": true, "ruleGroups": []}],
        "stepName": "条件判断",
        "stepJson": "{}"
    }, {
        "elementId": "nodeNode",
        ...
        "elementId": "switchNode",
        "stepId": "bda7748f-f87d-4a04-880e-eca936d59a0e",
        "nextSteps": [{
            "nextStep": "ccd691fc-8301-404b-847a-0304a7ef7a45",
            "name": "1",
            "isDefault": false
        }, {
            "nextStep": "9f0a671f-5fa4-4e2b-84d0-3f157a7f5da6",
            "name": "2",
            "isDefault": false
        }, {
            "nextStep": "cedce24b-b0bb-4e3c-bc08-d0a63794c16c",
            "name": "3",
            "isDefault": false
        }, {
            "nextStep": "9ac93355-d562-429c-b533-f80aa73771e0",
            "name": "4",
            "isDefault": false
        }, {"nextStep": "b5b80616-46db-433a-856c-176b2e53f3bb", "name": "5", "isDefault": false}],
        "stepName": "条件分组"
    }, {
        "elementId": "tempNode",
        "stepId": "ccd691fc-8301-404b-847a-0304a7ef7a45",
        "nextStep": null
    }, {
        "elementId": "tempNode",
        "stepId": "9f0a671f-5fa4-4e2b-84d0-3f157a7f5da6",
        "nextStep": null
    }, {
        "elementId": "tempNode",
        "stepId": "cedce24b-b0bb-4e3c-bc08-d0a63794c16c",
        "nextStep": null
    }, {
        "elementId": "tempNode",
        "stepId": "9ac93355-d562-429c-b533-f80aa73771e0",
        "nextStep": null
    }, {"elementId": "tempNode", "stepId": "b5b80616-46db-433a-856c-176b2e53f3bb", "nextStep": null}]
}
